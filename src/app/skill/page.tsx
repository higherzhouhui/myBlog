...
export default function SkillPage() {
  ...
  return (
    <Box sx={{ minHeight: 'calc(100vh - 80px)', padding: Sm ? '0 12px' : '12px 0' }}>
      <Box sx={{ backgroundImage: 'url(http://cn.bing.com/iod/1366/1024/201706221600)', height: Sm ? 420 : 320, width: '100%', backgroundSize: Sm ? '100% 100%' : '100%', backgroundRepeat: 'no-repeat' }}>
        <Typography sx={{ color: '#fff', fontSize: 32, pt: 6, ml: 4, letterSpacing: 4, fontWeight: 'bold' }}>致力于技术分享与生活记录</Typography>
        <Typography sx={{ color: '#fff', fontSize: 16, mt: 4, ml: 4, letterSpacing: 2, textDecoration: 'underline' }}>我原要昂扬独步天下，奈何却忍辱藏于污泥；我梦在叱咤风云，却无奈苦候时机；难道登峰造极，途中遍是荆棘……
        </Typography>
